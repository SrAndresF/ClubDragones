...
export default function inscripciones() {
  return (
    <Main title="Inscripciones😊">
      <div className='flex   sm:items-center h-screen items-start flex-col md:flex-row'>
      <div className="flex flex-col justify-center items-start ">
      <h3 className=" font-bold text-3xl lg:text-7xl ml-7 sm:ml-20 mb-4  sm:mt-0 ">Inscríbete</h3>
      <p className=" ml-7 sm:ml-20 w-2/3">Para inscribirte deberás seguir  los siguientes pasos, si presentas algún inconveniente contactanos.
      </p>
      <ul className=" list-decimal ml-12 sm:ml-24 mt-4 mb-4 w-1/2">
      ...
      <div className="   relative md:absolute ml-3 sm:ml-3 md:ml-0 sm:right-0 bg-principal rounded-full w-96 h-96  md:w-96 md:h-96 lg:w-128 lg:h-128 -z-10">
